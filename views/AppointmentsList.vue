...
export default {
  ...
  methods: {
    fetchAppointments() {
      fetch("https://62ruv3jbu5.execute-api.eu-north-1.amazonaws.com/final/appointments")
        .then(res => res.json())
        .then(data => {
    ...
    updateStatus(appointment, newStatus) {
      ...
      const url = `https://62ruv3jbu5.execute-api.eu-north-1.amazonaws.com/final/appointments/${appointment.appointmentId}`;
